...
export default function QualificationTest() {
  ...
  const questions = [
    {
      id: 1,
      question: "What is the maximum safe working load (SWL) for a standard tower crane?",
      options: [
    ...
    },
    {
      ...
      options: ["Once a year", "Only when there's a malfunction", "Daily before operation", "Every 5 years"],
      correctAnswer: 2,
    },
    {
      id: 4,
      question: "What is the proper procedure when a crane malfunctions during operation?",
      options: [
    ...
    {
      id: 5,
      question: "What documentation must be available on-site during crane operation?",
      options: [
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-3xl">
          <CardHeader>
            <CardTitle className="text-2xl">Professional Qualification Test</CardTitle>
            <CardDescription>
              {!testCompleted
          ...
          <CardContent>
            {!testCompleted ? (
              ...
              <div className="space-y-6 text-center">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2">{passed ? "Congratulations!" : "Test Failed"}</h3>
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <p className="text-lg font-medium">Your Score: {score.toFixed(0)}%</p>
                  <p className="text-sm text-muted-foreground">Passing Score: 70%</p>
                </div>
              </div>
            )}
          </CardContent>
            ...
            {!testCompleted ? (
              <>
                ...
                <Button onClick={handleNext} disabled={answers[currentQuestion] === undefined}>
                  {currentQuestion < questions.length - 1 ? "Next" : "Complete Test"}
                </Button>
              </>
            ) : (
              <Button className="w-full" onClick={handleComplete} disabled={!passed}>
